...
# Install supporteR from GitHub
#devtools::install_github("impact-initiatives/supporteR")
# install.packages("devtools")
#devtools::install_github("impact-initiatives/analysistools")

install.packages("supporteR")
...
# clean data
clean_loc_data <- "C:/Users/test/Downloads/20240826_ETH2403_eth_msna_cleaned_data_NEW.xlsx"
#View(clean_loc_data)
...
df_main_clean_data <- readxl::read_excel(clean_loc_data, col_types = clean_data_nms, sheet = "cleaned_data") |> 
